...
__all__ = [
    ...
    'UIA_IsMultipleViewPatternAvailablePropertyId', 'HeadingLevel8',
    'WindowInteractionState_NotResponding', 'TreeScope_Element',
    'ZoomUnit_SmallIncrement', 'UIA_AnnotationTargetPropertyId',
    'NavigateDirection_FirstChild', 'UIA_MenuModeEndEventId',
    'ToggleState_Indeterminate', 'UIA_LevelPropertyId',
    'UIA_SelectionPattern2Id', 'AnnotationType_AdvancedProofingIssue',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'IUIAutomationPropertyCondition', 'UIA_TitleBarControlTypeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'OrientationType_Horizontal', 'UIA_BoundingRectanglePropertyId',
    ...
    'UIA_IsActiveAttributeId', 'AnnotationType_Author',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_AnnotationTypesPropertyId', 'UIA_StylesStyleNamePropertyId',
    'IUIAutomationCondition', 'UIA_TransformCanRotatePropertyId',
    'UIA_MenuItemControlTypeId', 'UIA_FontWeightAttributeId',
    'UIA_UnderlineStyleAttributeId', 'AnnotationType_Endnote',
    'IUIAutomation4', 'StyleId_Heading6',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_Drag_DragCompleteEventId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_Drag_DragCancelEventId', 'UIA_SayAsInterpretAsMetadataId',
    ...
    'UIA_DragGrabbedItemsPropertyId', 'LiveSetting',
    'ProviderOptions', 'TreeTraversalOptions_LastToFirstOrder',
    'AnnotationType_SpellingError',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_SynchronizedInputPatternId', 'UIA_DockPatternId',
    'UIA_GridItemRowPropertyId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'IUIAutomationElementArray', 'UIA_SearchLandmarkTypeId',
    'UIA_TreeControlTypeId', 'UIA_IsOffscreenPropertyId',
    'UIA_ItemTypePropertyId', 'UIA_RuntimeIdPropertyId',
    'IUIAutomationSelectionPattern2',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_GridRowCountPropertyId', 'IUIAutomationTextRangeArray',
    'IUIAutomationTextRange3',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'SupportedTextSelection_Multiple', 'IUIAutomationElement4',
    'AnnotationType_UnsyncedChange', 'UIA_MenuOpenedEventId',
    ...
    'UIA_UnderlineColorAttributeId', 'TextUnit_Character',
    'UIA_SpinnerControlTypeId', 'StyleId_Title',
    'DockPosition_Bottom', 'AutomationElementMode_Full',
    ...
    'UIA_SizePropertyId', 'AnnotationType_Footer',
    ...
    'UIA_StylesFillPatternStylePropertyId', 'UIA_TextChildPatternId',
    'IUIAutomationTextChildPattern', 'IUIAutomationValuePattern',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_CalendarControlTypeId', 'UIA_IsReadOnlyAttributeId',
    'UIA_TableItemPatternId', 'UIA_StylesFillColorPropertyId',
    'UIA_IsValuePatternAvailablePropertyId', 'StyleId_Heading1',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'StyleId_Heading3', 'UIA_SizeOfSetPropertyId',
    'UIA_Selection2ItemCountPropertyId',
    'TextEditChangeType_AutoCorrect', 'StyleId_Heading2',
    'IUIAutomationDropTargetPattern', 'UIA_LiveSettingPropertyId',
    'HeadingLevel_None', 'NotificationKind_ActionCompleted',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_NotificationEventId', 'UIA_NavigationLandmarkTypeId',
    ...
    'UIA_SelectionItem_ElementSelectedEventId', 'DockPosition_Left',
    'TextUnit_Line', 'TextUnit_Word', 'IUIAutomationTransformPattern',
    'UIA_AutomationFocusChangedEventId', 'UIA_StatusBarControlTypeId',
    'UIA_AnnotationAuthorPropertyId', 'NavigateDirection_Parent',
    'DockPosition', 'UIA_IndentationFirstLineAttributeId',
    'CUIAutomation', 'IUIAutomationElement9',
    'AnnotationType_Footnote', 'UIA_OutlineColorPropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'ZoomUnit_LargeDecrement', 'UIA_AsyncContentLoadedEventId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'IUIAutomationSpreadsheetItemPattern', 'Polite',
    'UIA_FrameworkIdPropertyId', 'UIA_FillTypePropertyId',
    'TextUnit_Format', 'IUIAutomationStylesPattern',
    'UIA_TransformCanResizePropertyId',
    'RowOrColumnMajor_ColumnMajor', 'UIA_AnnotationObjectsPropertyId',
    'IUIAutomationSelectionItemPattern', 'NotificationProcessing',
    'UIA_CenterPointPropertyId', 'StyleId_Heading5',
    'StyleId_Emphasis', 'SynchronizedInputType_KeyDown',
    'UIA_SystemAlertEventId', 'UIA_DragIsGrabbedPropertyId',
    'UIA_AfterParagraphSpacingAttributeId', 'ZoomUnit_LargeIncrement',
    'IUIAutomationObjectModelPattern',
    'SynchronizedInputType_LeftMouseDown',
    'IUIAutomationTogglePattern', 'WindowInteractionState_Closing',
    'UIA_AriaPropertiesPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_ClassNamePropertyId', 'UIA_FlowsFromPropertyId',
    'UIA_CaretPositionAttributeId', 'UIA_AnnotationTypesAttributeId',
    'IUIAutomationElement3', 'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_StrikethroughStyleAttributeId', 'UIA_ListControlTypeId',
    'WindowInteractionState_Running', 'UIA_FlowsToPropertyId',
    'StructureChangeType_ChildAdded',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_SelectionPatternId', 'IUIAutomationAnnotationPattern',
    'UIA_ScrollPatternId', 'IUIAutomationBoolCondition',
    'IUIAutomationElement6', 'NotificationKind_ItemRemoved',
    'UIA_MarginTrailingAttributeId', 'DockPosition_Fill',
    'UIA_ToggleToggleStatePropertyId', 'DockPosition_Top',
    'UIA_Selection_InvalidatedEventId', 'UIA_BulletStyleAttributeId',
    'UIA_TextPatternId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'AnnotationType_Sensitive', 'IUIAutomationSpreadsheetPattern',
    'ExpandCollapseState_LeafNode', 'UIA_InvokePatternId',
    'UIA_Text_TextSelectionChangedEventId',
    'NotificationKind_ActionAborted', 'UIA_WindowPatternId',
    'HeadingLevel2', 'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomation3', 'UIA_MenuBarControlTypeId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_FontSizeAttributeId', 'UIA_CultureAttributeId',
    ...
    'UIA_TransformCanMovePropertyId', 'UIA_SemanticZoomControlTypeId',
    'HeadingLevel1', 'HeadingLevel4',
    'UIA_SelectionActiveEndAttributeId', 'UIA_StylesShapePropertyId',
    'UIA_ListItemControlTypeId', 'UIA_IsItalicAttributeId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_AnimationStyleAttributeId', 'UIA_ValuePatternId',
    'AnnotationType_Unknown', 'UIA_InputDiscardedEventId',
    'IUIAutomationTransformPattern2', 'SupportedTextSelection',
    'UIA_TransformPatternId', 'ZoomUnit', 'WindowInteractionState',
    'UIA_DropTarget_DragEnterEventId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'RowOrColumnMajor_RowMajor', 'UIA_ControllerForPropertyId',
    'UIA_StyleNameAttributeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'TreeScope_Children', 'UIA_HelpTextPropertyId',
    'AnnotationType_DeletionChange', 'ToggleState_Off',
    'UIA_LiveRegionChangedEventId', 'UIA_CapStyleAttributeId',
    'ToggleState', 'UIA_LegacyIAccessiblePatternId',
    'NotificationKind_Other', 'TextEditChangeType',
    ...
    'NotificationProcessing_CurrentThenMostRecent', 'UiaChangeInfo',
    'SynchronizedInputType_RightMouseUp',
    'UIA_AutomationPropertyChangedEventId', 'UIA_StylesPatternId',
    'UIA_IsSuperscriptAttributeId', 'IUIAutomationWindowPattern',
    'StyleId_BulletedList', 'NotificationProcessing_ImportantAll',
    'UIA_StyleIdAttributeId', 'IUIAutomationSynchronizedInputPattern',
    'ToggleState_On', 'TextEditChangeType_Composition',
    'UIA_IsHiddenAttributeId', 'NavigateDirection',
    'SynchronizedInputType', 'HeadingLevel9',
    'UIA_LayoutInvalidatedEventId', 'DockPosition_None',
    'IUIAutomationElement2', 'TextPatternRangeEndpoint_End',
    'UIA_IsKeyboardFocusablePropertyId',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_OverlineStyleAttributeId', 'StyleId_NumberedList',
    'UIA_ScrollVerticalViewSizePropertyId', 'TextUnit',
    'UIA_LegacyIAccessibleRolePropertyId', 'IUIAutomationTreeWalker',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_IsSubscriptAttributeId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_ProcessIdPropertyId',
    'UIA_DataGridControlTypeId',
    'UIA_LegacyIAccessibleValuePropertyId', 'StyleId_Heading7',
    'UIA_ProgressBarControlTypeId', 'UIA_ItemStatusPropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_SpreadsheetItemPatternId', 'IUIAutomationScrollItemPattern',
    'UIA_FormLandmarkTypeId', 'IUIAutomationElement7',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'AnnotationType_ExternalChange', 'IRawElementProviderSimple',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_TextPattern2Id', 'UIA_DescribedByPropertyId',
    'AnnotationType_Comment', 'UIA_IndentationTrailingAttributeId',
    'UIA_RadioButtonControlTypeId', 'UIA_ButtonControlTypeId',
    'WindowVisualState_Normal', 'IUIAutomationDockPattern',
    'UIA_Window_WindowClosedEventId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'AnnotationType_FormulaError', 'StyleId_Heading8',
    'UIA_GroupControlTypeId', 'TreeScope_None',
    'UIA_DropTarget_DroppedEventId', 'IUIAutomationTablePattern',
    'UIA_AppBarControlTypeId', 'UIA_SummaryChangeId',
    'UIA_GridItemRowSpanPropertyId',
    'ProviderOptions_ServerSideProvider', 'TreeScope_Subtree',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_LandmarkTypePropertyId', 'ExpandCollapseState_Expanded',
    'UIA_IsDockPatternAvailablePropertyId',
    'AnnotationType_GrammarError', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_TabItemControlTypeId',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_PositionInSetPropertyId', 'UIA_TogglePatternId',
    'IUIAutomationEventHandlerGroup', 'UIA_MenuModeStartEventId',
    'UIA_HasKeyboardFocusPropertyId',
    'IUIAutomationRangeValuePattern', 'UIA_RangeValueValuePropertyId',
    'UIA_Transform2CanZoomPropertyId', 'UIA_GridItemColumnPropertyId',
    'AnnotationType_DataValidationError',
    'UIA_RangeValueMinimumPropertyId', 'IUIAutomationEventHandler',
    'AnnotationType_Highlighted', 'IUIAutomationElement8',
    'ProviderOptions_HasNativeIAccessible', 'ZoomUnit_SmallDecrement',
    'UIA_RangeValueMaximumPropertyId', 'UIA_ChangesEventId',
    'UIA_ScrollBarControlTypeId', 'UIA_DockDockPositionPropertyId',
    'AnnotationType_Mathematics', 'WindowVisualState_Minimized',
    'UIA_PaneControlTypeId', 'RowOrColumnMajor', 'WindowVisualState',
    'IUIAutomationGridItemPattern', 'IUIAutomationDragPattern',
    'StyleId_Normal', 'CoalesceEventsOptions_Disabled',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'IUIAutomationMultipleViewPattern',
    'IUIAutomationSelectionPattern',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'CoalesceEventsOptions_Enabled', 'UIA_ComboBoxControlTypeId',
    'UIA_AutomationIdPropertyId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_ToolTipClosedEventId', 'StyleId_Heading9',
    'UIA_LabeledByPropertyId', 'UIA_MultipleViewPatternId',
    'UIA_MenuClosedEventId', 'IUIAutomationProxyFactoryEntry',
    'CoalesceEventsOptions', 'UIA_Invoke_InvokedEventId',
    'ProviderOptions_ClientSideProvider',
    'UIA_NativeWindowHandlePropertyId', 'UIA_ToolTipControlTypeId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_SliderControlTypeId',
    'StyleId_Subtitle', 'UIA_InputReachedOtherElementEventId',
    'ConnectionRecoveryBehaviorOptions', 'HeadingLevel6',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_StructureChangedEventId', 'IUIAutomationOrCondition',
    'UIA_ScrollItemPatternId', 'UIA_AnnotationPatternId',
    'OrientationType_Vertical', 'IUIAutomationInvokePattern',
    ...
    'UIA_AccessKeyPropertyId', 'UIA_DragDropEffectsPropertyId',
    'UIA_TransformPattern2Id',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'NavigateDirection_NextSibling', 'PropertyConditionFlags',
    'AnnotationType_FormatChange', 'UIA_HeaderItemControlTypeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_DragDropEffectPropertyId', 'UIA_IsEnabledPropertyId',
    'TreeTraversalOptions_Default', 'IUIAutomationAndCondition',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_CulturePropertyId', 'NotificationKind',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_DataItemControlTypeId', 'TreeTraversalOptions_PostOrder',
    'IUIAutomationElement', 'RowOrColumnMajor_Indeterminate',
    'AnnotationType_Header', 'UIA_VirtualizedItemPatternId',
    'UIA_IsControlElementPropertyId', 'UIA_DropTargetPatternId',
    'ProviderOptions_UseClientCoordinates',
    'UIA_CustomLandmarkTypeId', 'IUIAutomationTableItemPattern',
    ...
    'UIA_VisualEffectsPropertyId', 'UIA_SplitButtonControlTypeId',
    ...
    'UIA_DragPatternId', 'UIA_GridItemContainingGridPropertyId',
    'IUIAutomation', 'UIA_ExpandCollapsePatternId',
    'UIA_WindowControlTypeId', 'IUIAutomationElement5',
    'IUIAutomation5', 'UIA_MarginLeadingAttributeId',
    'UIA_SeparatorControlTypeId', 'UIA_ToolTipOpenedEventId',
    'AnnotationType_InsertionChange', 'UIA_OverlineColorAttributeId',
    'UIA_Drag_DragStartEventId', 'TextUnit_Document',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_SelectionSelectionPropertyId', 'TreeScope_Ancestors',
    'TextEditChangeType_CompositionFinalized',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_BackgroundColorAttributeId',
    'NavigateDirection_PreviousSibling', 'UIA_ValueValuePropertyId',
    'UIA_IndentationLeadingAttributeId', 'UIA_AriaRolePropertyId',
    'IUIAutomationTextEditPattern', 'UIA_HeadingLevelPropertyId',
    'Off', 'IUIAutomationScrollPattern', 'UIA_TableControlTypeId',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_SpreadsheetPatternId',
    'ConnectionRecoveryBehaviorOptions_Disabled', 'OrientationType',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'SupportedTextSelection_None', 'TreeScope_Descendants',
    'UIA_DocumentControlTypeId', 'CUIAutomation8',
    'AnnotationType_ConflictingChange',
    'UIA_ProviderDescriptionPropertyId', 'TreeScope',
    'AnnotationType_MoveChange', 'UIA_OutlineThicknessPropertyId',
    'SupportedTextSelection_Single', 'UIA_NamePropertyId',
    'NotificationKind_ItemAdded', 'Assertive',
    'IUIAutomationProxyFactory',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_ThumbControlTypeId',
    'StyleId_Custom', 'TextPatternRangeEndpoint_Start',
    'IUIAutomation2', 'UIA_RangeValuePatternId',
    'TextPatternRangeEndpoint',
    'UIA_StylesFillPatternColorPropertyId', 'IUIAutomationTextRange',
    'WindowVisualState_Maximized',
    'UIA_RangeValueSmallChangePropertyId', 'IAccessible',
    'AutomationElementMode_None',
    'IUIAutomationVirtualizedItemPattern',
    'IUIAutomationCustomNavigationPattern', 'HeadingLevel3',
    ...
    'AnnotationType_TrackChanges', 'UIA_ControlTypePropertyId',
    'UIA_ToolBarControlTypeId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'ProviderOptions_OverrideProvider', 'ScrollAmount_LargeDecrement',
    'IUIAutomationItemContainerPattern',
    'UIA_StrikethroughColorAttributeId', 'ZoomUnit_NoAmount',
    'UIA_MarginBottomAttributeId', 'ScrollAmount_SmallDecrement',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_WindowIsModalPropertyId', 'TreeScope_Parent',
    'UIA_StylesStyleIdPropertyId', 'HeadingLevel5',
    'IUIAutomationTextPattern', 'StructureChangeType',
    'TreeTraversalOptions', 'StructureChangeType_ChildRemoved',
    'UIA_LinkAttributeId', 'PropertyConditionFlags_None',
    'UIA_TabControlTypeId', 'TextUnit_Page',
    'UIA_MarginTopAttributeId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_MainLandmarkTypeId', 'NavigateDirection_LastChild',
    'UIA_TextFlowDirectionsAttributeId', 'StyleId_Heading4',
    'TextEditChangeType_None', 'UIA_IsPeripheralPropertyId',
    'TextEditChangeType_AutoComplete',
    'UIA_IsTextPatternAvailablePropertyId', 'ExpandCollapseState',
    'UIA_ImageControlTypeId', 'DockPosition_Right',
    'UIA_HeaderControlTypeId',
    'UIA_IsStylesPatternAvailablePropertyId', 'ExtendedProperty',
    'UIA_Text_TextChangedEventId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_HyperlinkControlTypeId', 'UIA_TabsAttributeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_SelectionItemPatternId', 'ScrollAmount',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_CaretBidiModeAttributeId', 'UIA_GridPatternId',
    'UIA_WindowCanMinimizePropertyId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_TreeItemControlTypeId',
    'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationNotificationEventHandler',
    'UIA_FillColorPropertyId', 'UIA_ForegroundColorAttributeId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_TextEditPatternId', 'UIA_TablePatternId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_EditControlTypeId', 'SynchronizedInputType_KeyUp',
    'UIA_Window_WindowOpenedEventId',
    'SynchronizedInputType_LeftMouseUp',
    'AnnotationType_EditingLockedChange', 'IUIAutomationTextRange2',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_LineSpacingAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'AutomationElementMode', 'HeadingLevel7', 'TextUnit_Paragraph',
    'StyleId_Quote', 'NotificationProcessing_MostRecent',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_GridItemPatternId', 'ExpandCollapseState_Collapsed'
]

_check_version('1.2.0', 1688195545.887950)
